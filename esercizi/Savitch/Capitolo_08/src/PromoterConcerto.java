...
public class PromoterConcerto {
     ...
     */
    public void inizializza(String band, int max, double costoTelefono, double costoSulLuogo) {
        nomeBand = band;
        capacita = max;
        bigliettiVenduti = 0;
 ...
 public static void main(String[] args) {
        PromoterConcerto concerto = new PromoterConcerto();
        concerto.inizializza("Maneskin", 100, 10.00 , 12.00);
