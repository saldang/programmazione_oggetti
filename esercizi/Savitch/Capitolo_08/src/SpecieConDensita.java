...
public class SpecieConDensita {
	...
	/**
	 Precondizone: anni deve essere un intero positivo
	...
	*/
	...
	public double getDensita(double area) { 
		return popolazione / area;
	}
	
	public boolean equals(SpecieConDensita altroOggetto) {
