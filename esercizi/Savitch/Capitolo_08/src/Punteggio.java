...
public class Punteggio {
	...
	public void inizializza(String descrizoneAssegnata, int max) {
	...
	public static void main(String[] args) {
		...
		Punteggio punteggioFilm = new Punteggio();
		Punteggio punteggioRistorante = new Punteggio();
		punteggioFilm.inizializza("Effetti sonori", 5);
		punteggioRistorante.inizializza("Qualita' del cibo", 10);
