...
public class NumeroDiTelefonoSerializzato implements Serializable {
    ...
    public NumeroDiTelefonoSerializzato(String input) throws NumeroTelefonicoNonValidoException {
