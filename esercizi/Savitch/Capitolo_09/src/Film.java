public class Film {
	...
	private int numeroValutati1, numeroValutati2, numeroValutati3, numeroValutati4, numeroValutati5;

	// Costruttore di default
	public Film() {
		setNome("sconosciuto");
		setPunteggioMPAA("sconosciuto");
		numeroValutati1 = 0;
		numeroValutati2 = 0;
		numeroValutati3 = 0;
		numeroValutati4 = 0;
	...
	// Costruttore con valori per nome e punteggio
	public Film(String ilNome, String ilPunteggio) {
		setNome(ilNome);
		setPunteggioMPAA(ilPunteggio);
		numeroValutati1 = 0;
		numeroValutati2 = 0;
		numeroValutati3 = 0;
		numeroValutati4 = 0;
	...
	public double getMedia() {
		return (numeroValutati1 + 2 * numeroValutati2 + 3 * numeroValutati3 + 4 * numeroValutati4 + 5 * numeroValutati5)
				/ 5.0;
	}

	public static void main(String[] args) {
		Film m1 = new Film("I guardiani del destino", "PG-13");
		...
		Film m2 = new Film("Sono il Numero Quattro", "PG-13");
