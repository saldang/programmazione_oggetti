...
public class ChiediOAfferma {
	public static void main(String[] args) {
		...
		int risposta; // sentinella per continuare o terminare il programma

		do { // chidi una frase e mostra la risposta
			...
			System.out.println("Inserisci s per si e n per no.");
			risposta = tastiera.nextLine().charAt(0);
