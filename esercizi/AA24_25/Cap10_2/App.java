...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Inserisci la soglia di pagamento da stampare:");
        // App.soglia = tastiera.nextDouble();
        System.out.println(pagamenti[2].getSoglia());
        System.out.println(PagamentoCarta.getSoglia());
        System.out.println(PagamentoContanti.getSoglia());

        PagamentoCarta.setSoglia(100.0);
        System.out.println(PagamentoCarta.getSoglia());

        for (Pagamento pagamento : pagamenti) {
            System.out.println(pagamento.getSoglia());
            if (App.pagamentoSuperioreA(pagamento, Pagamento.getSoglia()))
