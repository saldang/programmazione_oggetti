...
public class TabellaInteressi2 {
	...
	Postcondizione: Il contenuto dell�array e� visualizzato con il segno della valuta.
	*/
	public static void visualizzaTabella(int[][] unArray) {
		...
		for (int riga = 0; riga < unArray.length; riga++) {
			...
			for (int colonna = 0; colonna < unArray[0].length; colonna++)
	...
	/**
	Ritorna il bilancio in conto dopo un dato numero di anni
